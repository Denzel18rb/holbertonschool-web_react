...
const loggedUser = { email: 'gaseosagalactica@gmail.com', password: '666chamuco', isLoggedIn: true };
...
describe("<App />", () => {
    ...
    it("verify that the logIn function updates the state correctly", () => {
        ...
        expect(wrapper.state().user.email).toBe('gaseosagalactica@gmail.com');
        expect(wrapper.state().user.password).toBe('666chamuco');
